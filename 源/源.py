...
def 热浴稳定新(温度, 热浴):  # 用二次函数拟合最近2分钟内的取的128个点，一次和二次项小于某一限值即可，并输出过程中的温度表和稳定时间
    通道 = 热浴[3]
...
def 温度计转换(输入, 转换号):
    转换 = {'热浴': [3.1370706260, -0.9419809565, 31.1355065340, 0.8985929852, -1.7105170129, 0.0624105876,
          ...
          # 多项式拟合
          '高温侧0T简': [10561.96288, 2.46684695],
          '低温侧0T简': [10891.84685, 2.522445166],
          "热导20220713右": [10458.39001, 2.553974275],
          "热导20220713左": [10905.96638, 2.506844122],
          "热导20220713上": [10578.2275, 2.447167304],
          }
