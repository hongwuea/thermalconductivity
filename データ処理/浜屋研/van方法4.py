...
if __name__ == '__main__':
    ...
    文件表 = ['20220808_CFVMS_BAT--200V_out-of-plane_I(6-16)_V1(NONE)_V2(1-11)_V3(NONE)_300K_1mA_0deg_0Ω_1-1.txt',
           '20220808_CFVMS_BAT--200V_out-of-plane_I(11-16)_V1(NONE)_V2(1-6)_V3(NONE)_300K_1mA_0deg_0Ω_1-1.txt',
           '20220808_CFVMS_BAT--200V_out-of-plane_I(1-16)_V1(NONE)_V2(6-11)_V3(NONE)_300K_1mA_0deg_0Ω_1-1.txt',
           '20220808_CFVMS_BAT--200V_out-of-plane_I(11-16)_V1(NONE)_V2(6-1)_V3(NONE)_300K_1mA_0deg_0Ω_1-1.txt']
    窗口表 = []
    正负转换 = iter([-1, 1,- 1,-1])
    for 文件名 in 文件表:
